...
public interface IOperationService {
	 ...
	 */
	public abstract OperationEntity select(int unUtilisateurId, int unCompteId, int uneOperationId)
	 ...
	 *             si un probleme technique survient
	 */
	public abstract List<OperationEntity> selectAll(int unUtilisateurId, int unCompteId)
			throws FonctionnelleException, ErreurTechniqueException;
	 ...
	 *             si un probleme technique survient
	 */
	public abstract List<OperationEntity> selectCritere(int unUtilisateurId, int unCompteId, Date unDebut, Date uneFin,
